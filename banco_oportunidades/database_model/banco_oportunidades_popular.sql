...
INSERT INTO Usuarios (nome, email, senha_hash, cpf_cnpj, tipoUsuario, telefone, endereco, cidade, uf) VALUES
('Carlos da Silva', 'carlao@gmail.com', 'hash123', '12345678901', 'prestador', '11987654321', 'Rua das Flores, 100', 'Maringá', 'PR'),
...
INSERT INTO Servicos (Categorias_idCategorias, titulo, descricao, preco, cidade, status)
VALUES
(1, 'Manutenção de Jardim', 'Poda de árvores, corte de grama e adubação mensal.', 150.00, 'Maringá', 'ativo'),
(2, 'Pintura Residencial', 'Pintura completa de casas até 100m² com tinta fornecida.', 1200.00, 'Sarandi', 'ativo'),
(5, 'Limpeza Pós-Obra', 'Serviço completo de limpeza após reforma ou construção.', 300.00, 'Maringá', 'ativo'),
(4, 'Conserto de Roupas', 'Ajustes, bainhas e consertos diversos em roupas.', 50.00, 'Maringá', 'ativo'),
(3, 'Ronda Noturna', 'Serviço de vigilância residencial das 22h às 6h.', 800.00, 'Maringá', 'ativo');

INSERT INTO Transacoes (Servicos_idServicos, Usuarios_idUsuarios, valorPago, status, avaliacao) VALUES
